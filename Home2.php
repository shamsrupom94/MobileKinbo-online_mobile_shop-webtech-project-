...
<body>
   ...
   <div id="brandcar">
   	...
   	<div id="pro2">
   			<div class="container">
                <img src="image/xiaomi.jpg"  class="image" width="290" height="290">
               
						<div class="middle">
				<div class="text"><a id="detailsbutton" href="ProductShowApple.php?brand_name=Apple">Xiaomi</a></div>
			</div>
   	...
   	<div id="pro4">
   		<div class="container">
                <img src="image/htc.jpg"  class="image" width="290" height="290">
						...
						<div class="middle">
				<div class="text"><a id="detailsbutton" href="ProductShowApple.php?brand_name=Apple">HTC</a></div>
			</div>
